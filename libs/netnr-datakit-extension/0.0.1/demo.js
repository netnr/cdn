...
(function (dk) {
    if (dk) {
        ...
        dk.build.language.csharp["extendClass"] = function am(pa) {
            //项目命名，同时也是类所属文件夹名
        ...
        //添加注释
        dk.build.language.csharp["extendClass-comment"] = "拓展类";

        //删除 java 的注释
        delete dk.build.language["java-comment"];

        //添加新的语言，注意：语种需 Monaco editor 编辑器支持
        dk.build.language["javascript"] = {
